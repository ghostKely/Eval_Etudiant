 ...
 */
@WebServlet(name = "C_EtudiantAnneeAll_R", urlPatterns = {"/C_EtudiantAnneeAll_R"})
public class C_EtudiantAnneeAll_R extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet C_EtudiantAnneeAll_R</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet C_EtudiantAnneeAll_R at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String destinationPage = "Home_User.jsp";
                request.setAttribute("content", "../contentUser/List_AnneeAll.jsp");
