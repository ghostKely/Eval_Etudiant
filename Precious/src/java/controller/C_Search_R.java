 ...
 */
@WebServlet(name = "C_Search_R", urlPatterns = {"/C_Search_R"})
public class C_Search_R extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet C_Search_R</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet C_Search_R at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String recherche = request.getParameter("nomEtudiant");
            List<Etudiant> listeEtudiantCible = etudiant.searchEtudiantByNom(listeEtudiant, recherche);
                request.setAttribute("liste_Etudiant", listeEtudiantCible);
